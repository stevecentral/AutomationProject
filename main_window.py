...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.instructions_w = AnotherWindow()
        self.instructions_w.setGeometry(QtCore.QRect(700, 300, 500, 500))
        self.instruction_label = QtWidgets.QLabel
        """self.instruction_label.setText(QLabel, "login: login,"
                                                    "logout: logout,"
...
"""
        ...
        self.w.setGeometry(QtCore.QRect(700, 300, 500, 500))
        self.elementNamesButton.clicked.connect(self.toggle_window)
    ...
    def load_json(self):
        ...
        with open('configuration.hjson', 'r') as f:
            data = json.load(f)
            formatted_json = json.dumps(data, indent=4)
            self.text_edit.setPlainTest(formatted_json)
